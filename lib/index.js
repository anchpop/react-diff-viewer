...
var DiffViewer = /** @class */ (function (_super) {
    ...
    function DiffViewer(props) {
        ...
        _this.flattenDiffInformation = function (diffArray) {
            return diffArray.map(function (wordDiff, i) { return wordDiff.value; }).join('');
        };
        /**
         ...
         */
        _this.renderLine = function (lineNumber, type, prefix, value, showAdded, additionalLineNumber, additionalPrefix) {
            var _a, _b, _c, _d;
            ...
            if (added === true && !showAdded) {
                var plainContent = "";
                if (Array.isArray(value)) {
                    plainContent = _this.flattenDiffInformation(value);
                }
                else {
                    plainContent = value;
                }
        ...
        _this.renderSplitView = function (_a, index) {
            ...
            return (React.createElement("tr", { key: index, className: _this.styles.line },
                _this.renderLine(left.lineNumber, left.type, LineNumberPrefix.LEFT, left.value, true),
                _this.renderLine(right.lineNumber, right.type, LineNumberPrefix.RIGHT, right.value, true)));
        };
        /**
         ...
         * @param index React key for the lines.
         */
        _this.renderInlineView = function (_a, index, showAdded) {
            var left = _a.left, right = _a.right;
            var content;
            if (left.type === compute_lines_1.DiffType.REMOVED && right.type === compute_lines_1.DiffType.ADDED) {
                return (React.createElement(React.Fragment, { key: index },
                    React.createElement("tr", { className: _this.styles.line }, _this.renderLine(left.lineNumber, left.type, LineNumberPrefix.LEFT, left.value, showAdded, null)),
                    React.createElement("tr", { className: _this.styles.line }, _this.renderLine(null, right.type, LineNumberPrefix.RIGHT, right.value, showAdded, right.lineNumber))));
            }
            if (left.type === compute_lines_1.DiffType.REMOVED) {
                content = _this.renderLine(left.lineNumber, left.type, LineNumberPrefix.LEFT, left.value, showAdded, null);
            }
            if (left.type === compute_lines_1.DiffType.DEFAULT) {
                content = _this.renderLine(left.lineNumber, left.type, LineNumberPrefix.LEFT, left.value, showAdded, right.lineNumber, LineNumberPrefix.RIGHT);
            }
            if (right.type === compute_lines_1.DiffType.ADDED) {
                content = _this.renderLine(null, right.type, LineNumberPrefix.RIGHT, right.value, showAdded, right.lineNumber);
            }
        ...
        _this.renderDiff = function () {
            var _a = _this.props, oldValue = _a.oldValue, newValue = _a.newValue, splitView = _a.splitView, disableWordDiff = _a.disableWordDiff, compareMethod = _a.compareMethod, linesOffset = _a.linesOffset, showAdded = _a.showAdded;
            ...
            return lineInformation.map(function (line, i) {
                ...
                var diffNodes = splitView
                    ...
                    : _this.renderInlineView(line, i, showAdded);
